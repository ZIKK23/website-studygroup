...
export function Navbar() {
  ...
  return (
    <>
      <nav className="fixed top-6 left-1/2 z-50 -translate-x-1/2 w-[90%] max-w-5xl rounded-full border border-white/20 bg-white/90 backdrop-blur-xl shadow-lg shadow-black/5 transition-all">
